...
class TimeDateFinder:
    ...
    def time_date_extract(t: str) -> str:
        ...
        date_finder = r'\b(\d{4})[-\/](0?[1-9]|1[0-2])[-\/](0?[1-9]|[12][0-9]|3[01])\b'
        ...
        for i, part in enumerate(text_l):
            # Check for month names or dates with months
            ...
            # Extract exact date-time format
            elif re.findall(date_time_finder, part):
                # Check for following time component
                if i + 2 < len(text_l):
